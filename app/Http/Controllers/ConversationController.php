    ...
    public function store_message(Request $request)
    {
        ...
        if (env('SMS_ENABLED') && isset($case->owner_phone) && $notify) {
            if ($validated['messagetype'] == 'message') {
                ...
                $text = "Hei ". $case->owner_name .", Vi har nettopp forsøkt å ringe deg i relasjon til sak ". $case->reference .". Du kan gjerne ringe oss opp dersom dette passer deg. Saksdetaljer: ". $url ." Vi ønsker deg en frydefull dag! Mvh Gjesteservice TusenFryd";
            }
