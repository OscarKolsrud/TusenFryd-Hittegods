@if (session('message'))
  <div class="alert alert-{{ Session::get('status') }} status-box alert-dismissable fade show" role="alert">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;<span class="sr-only">Lukk</span></a>
    {{ session('message') }}
  </div>
@endif
...
@if (session('success'))
  <div class="alert alert-success alert-dismissable fade show" role="alert">
    ...
    <h4><i class="icon fa fa-check fa-fw" aria-hidden="true"></i> Suksess</h4>
    {{ session('success') }}
  </div>
@endif
