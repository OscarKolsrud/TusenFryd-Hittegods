<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('category_store_admin') }}" method="post">
            @csrf
            <div class="form-group">
                <label for="category_name">Kategori navn</label>
                <input type="text" name="category_name" class="form-control" id="category_name" placeholder="Navn" value="{{ old('category_name') }}">
            </div>
            <div class="form-group">
